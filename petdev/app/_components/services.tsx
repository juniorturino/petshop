...
const services = [
    ...
    {
        title: "Táxi Pet",
        description: "Serviço de transporte para levar e buscar o pet no petshop, clínica veterinárias ou outros locais. Ideal para tutores que não tem tempo ou transporte adequado para locomover os animais.",
        duration: "2h",
        price: "$80",
        icon: <CarTaxiFront/>,
                                ...
                                <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                        ...
                                        <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                                            ...
                                            <a href="#" className="flex items-center justify-center gap-2 hover:bg-red-500 px-4 py-1 rounded-md duration-300">Entrar em contato
