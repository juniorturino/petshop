      ...
      <div className="container mx-auto pt-16 pb-16 md:pb-0 px-4 relative">
        ...
        <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <h1 className="text-3xl md:text-4xl font-bold leading-10" data-aos="fade-down">
            ...
            <a data-aos="fade-up" data-aos-delay="500" href="#"
              ...
              <div className="mt-8">
              <p className="text-sm mb-4" data-aos="fade-up-left" data-aos-delay="300">
                <b className="bg-black text-white px-2 py-1 rounded-md">5%</b> de desconto na primeira compra
              </p>

              <div className="flex mt-4">
                <div className="w-32 hidden lg:block" data-aos="fade-up-left" data-aos-delay="300">
                  <Image 
                    src="/cat-hero.png"
                    alt="Foto do gato"
                    width={128}
